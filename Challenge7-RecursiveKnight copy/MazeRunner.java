//UIUC CS125 SPRING 2017 MP. File: MazeRunner.java, CS125 Project: Challenge7-RecursiveKnight, Version: 2017-04-11T09:33:02-0500.466225000
//@author mapope2
public class MazeRunner {
	...
	static int findShortestString(String[] paths, int lo, int hi) {
		if (lo==hi)
			return lo;
		int min = findShortestString(paths,lo+1,hi); 
		if(safeStringLength(paths[min])<safeStringLength(paths[lo])) 
			return min; 
		return lo; 
	}
